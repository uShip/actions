...
- fix: because emojis are always better ([@RichiCoder1](https://github.com/RichiCoder1))
...
# v1.1.4 (Wed Apr 14 2021)

#### 🐛 Bug Fix

- fix: render out count correctly ([@RichiCoder1](https://github.com/RichiCoder1))
...
# v1.1.3 (Wed Apr 14 2021)

#### 🐛 Bug Fix

- fix: only render non-zero counts ([@RichiCoder1](https://github.com/RichiCoder1))
...
# v1.1.2 (Wed Apr 14 2021)

#### 🐛 Bug Fix

- fix: show correct destroy count ([@RichiCoder1](https://github.com/RichiCoder1))
...
# v1.1.1 (Wed Apr 14 2021)

#### 🐛 Bug Fix

- fix: actually regen dist ([@RichiCoder1](https://github.com/RichiCoder1))
...
- fix: actually apply patch package ([@RichiCoder1](https://github.com/RichiCoder1))
...
# v0.5.9 (Sat Apr 10 2021)

#### 🐛 Bug Fix

- fix: use single quotes ([@RichiCoder1](https://github.com/RichiCoder1))
...
- fix: actually fix version ([@RichiCoder1](https://github.com/RichiCoder1))
...
# v0.5.6 (Sat Apr 10 2021)

#### 🐛 Bug Fix

- fix: print resulting json ([@RichiCoder1](https://github.com/RichiCoder1))
...
- fix: make logs _very_ verbose ([@RichiCoder1](https://github.com/RichiCoder1))
...
# v0.5.3 (Sat Apr 10 2021)

#### 🐛 Bug Fix

- fix: make autoit verbose ([@RichiCoder1](https://github.com/RichiCoder1))
...
# v0.5.2 (Sat Apr 10 2021)

#### 🐛 Bug Fix

- fix: change how version is parsed out ([@RichiCoder1](https://github.com/RichiCoder1))
...
# v0.5.1 (Sat Apr 10 2021)

#### 🐛 Bug Fix

- fix: automatically bump docs version on new release ([@RichiCoder1](https://github.com/RichiCoder1))
...
- fix: the world is terrible and maybe this will work ([@RichiCoder1](https://github.com/RichiCoder1))
...
# v0.4.5 (Sat Apr 10 2021)

#### 🐛 Bug Fix

- fix: actually use the actual outputs ([@RichiCoder1](https://github.com/RichiCoder1))
...
# v0.4.4 (Sat Apr 10 2021)

#### 🐛 Bug Fix

- fix: actually filter exit code ([@RichiCoder1](https://github.com/RichiCoder1))
...
- fix: show error logs for all steps ([@RichiCoder1](https://github.com/RichiCoder1))
- chore(deps): update auto to v10.24.3 [#15](https://github.com/uShip/actions/pull/15) ([@renovate-bot](https://github.com/renovate-bot) [@renovate[bot]](https://github.com/renovate[bot]))
- chore(deps): update dependency execa to v5 [#13](https://github.com/uShip/actions/pull/13) ([@renovate-bot](https://github.com/renovate-bot) [@renovate[bot]](https://github.com/renovate[bot]))
- chore(deps): update dependency globby to v11 [#14](https://github.com/uShip/actions/pull/14) ([@renovate-bot](https://github.com/renovate-bot) [@renovate[bot]](https://github.com/renovate[bot]))
- chore(deps): update dependency @vercel/ncc to v0.28.2 [#11](https://github.com/uShip/actions/pull/11) ([@renovate-bot](https://github.com/renovate-bot) [@renovate[bot]](https://github.com/renovate[bot]))
- chore(deps): update dependency typescript to v4.2.4 [#12](https://github.com/uShip/actions/pull/12) ([@renovate-bot](https://github.com/renovate-bot) [@renovate[bot]](https://github.com/renovate[bot]))
- chore(deps): update auto to v10.24.1 [#9](https://github.com/uShip/actions/pull/9) ([@renovate-bot](https://github.com/renovate-bot) [@renovate[bot]](https://github.com/renovate[bot]))
- chore(deps): update dependency @types/node to v14.14.37 [#10](https://github.com/uShip/actions/pull/10) ([@renovate-bot](https://github.com/renovate-bot) [@renovate[bot]](https://github.com/renovate[bot]))

#### ⚠️ Pushed to `main`

- chore(deps): package tweaks and remove unused ([@RichiCoder1](https://github.com/RichiCoder1))
- chore(deps): update husky ([@RichiCoder1](https://github.com/RichiCoder1))
- chore: move renovate to correct location ([@RichiCoder1](https://github.com/RichiCoder1))
- chore: clean up prettier linting ([@RichiCoder1](https://github.com/RichiCoder1))
- chore: limit lint for some files to just workspaces ([@RichiCoder1](https://github.com/RichiCoder1))
- chore(deps): update renovate ([@RichiCoder1](https://github.com/RichiCoder1))
- chore: update package version and add build script for example action ([@RichiCoder1](https://github.com/RichiCoder1))
